...
const LoginSignUp = () => {
    ...
    const [avatar, setAvatar] = useState(inAvatar);
    ...
    return (
        <Fragment>
            {loading ? (
                ...
                <Fragment>
                    <MetaData title="Register Or Login Into Discount" />
                        ...
                        <div className="LoginSignUpBox">
                            ...
                            <form className="loginForm" ref={loginTab} onSubmit={loginSubmit}>
                                <div className="loginEmail">
                                    <MailOutlineIcon />
                                    <input type="email" id="email" placeholder="Enter Email" required value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} />
                                </div>
                                <div className="loginPassword">
                                    <LockOpenIcon />
                                    <input type="password" id="password" placeholder="Enter Password" required value={loginPassword} onChange={(e) => setLoginPassword(e.target.value)} />
                                </div>
