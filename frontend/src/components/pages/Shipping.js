                    ...
                    <Fragment>
                        ...
                        <div className="sup-dup-products2">
                            ...
                            <div className="shippingBox">
                                <h2 className="homeHeading2 mauto">Shipping Details</h2>

                                <form className="loginForm" encType="multipart/form-data" onSubmit={shippingSubmit} >
                                    ...
                                    <input type="submit" value="Continue" className="loginBtn" disabled={state ? false : true} />
                                </form>
                            </div>
                        </div>
